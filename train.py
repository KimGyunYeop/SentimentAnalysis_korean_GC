...
def train(args,
    ...
    optimizer_grouped_parameters = [
        ...
        {'params': [p for n, p in model.named_parameters() if any(nd in n for nd in no_decay) and any(nd in n for nd in weight_decay_change)], 'weight_decay': 0.0},
        {'params': [p for n, p in model.named_parameters() if not any(nd in n for nd in weight_decay_change)], 'weight_decay': 0.3}
    ]
