...
def main(cli_args):
    ...
    checkpoints = list(
            ...
            sorted(glob.glob(os.path.join(args.ckpt_dir, cli_args.result_dir)+"/**/"+"training_model.bin", recursive=True))
        )
    ...
    for checkpoint in checkpoints:
        ...
        model.load_state_dict(torch.load(checkpoint+"/training_model.pt"))
