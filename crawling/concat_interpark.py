...
f1 = open("../crawling/sports_auc.txt", encoding='utf-8-sig')
f2 = open("../crawling/sports_auc_2.txt", encoding='utf-8-sig')
f3 = open("../crawling/sports_auc_basketball.txt", encoding='utf-8-sig')
...
pos = 0
neg = 0
pos, neg, idx_idx, arr_ip = convertFormat(pos, neg, 0, 0, f1)
f1.close()
pos, neg, idx_idx, arr_ip2 = convertFormat(pos, neg, 0, idx_idx, f2)
f2.close()
pos, neg, idx_idx, arr_ip3 = convertFormat(pos, neg, 0, idx_idx, f3)
f3.close()
pos, neg, idx_idx, arr_ip4 = convertFormat(pos, neg, 0, idx_idx, f4)
f4.close()
pos, neg, idx_idx, arr_ip5 = convertFormat(pos, neg, 0, idx_idx, f5)
f5.close()
